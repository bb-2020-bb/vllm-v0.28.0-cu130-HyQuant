...
def new_kv_cache_spec(
    ...
    prefix_cache_private_tail_tokens=0,
):
    return FullAttentionSpec(
        ...
        prefix_cache_private_tail_tokens=prefix_cache_private_tail_tokens,
    )
...
def test_merge_kv_cache_spec():
    ...
    private_tail_specs = [
        new_kv_cache_spec(prefix_cache_private_tail_tokens=256),
        new_kv_cache_spec(prefix_cache_private_tail_tokens=256),
    ]
    merged_private_tail_spec = private_tail_specs[0].merge(private_tail_specs)
    assert merged_private_tail_spec.prefix_cache_private_tail_tokens == 256
