...
class DefaultModelState(ModelState):
    ...
    def prepare_attn(
        ...
        attn_metadata = build_attn_metadata(
            ...
            hyquant_state_slots=input_batch.hyquant_state_slots,
            hyquant_state_slots_cpu=input_batch.hyquant_state_slots_cpu,
            hyquant_prompt_lens=input_batch.hyquant_prompt_lens,
            hyquant_prompt_lens_cpu=input_batch.hyquant_prompt_lens_cpu,
            hyquant_cached_prefix_lens=input_batch.hyquant_cached_prefix_lens,
            hyquant_cached_prefix_lens_cpu=(
                input_batch.hyquant_cached_prefix_lens_cpu
            ),
        )
