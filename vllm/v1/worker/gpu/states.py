...
class RequestState:
    def __init__(
        ...
        # Immutable number of compact prompt tokens available when the worker
        # first sees a request. It is zero without automatic prefix caching.
        self.hyquant_cached_prefix_len = UvaBackedTensor(
    ...
    def add_request(
        ...
        self.hyquant_cached_prefix_len.np[req_idx] = num_computed_tokens
    ...
    def apply_staged_writes(self) -> None:
        ...
        self.hyquant_cached_prefix_len.copy_to_uva()
